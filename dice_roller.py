...
if __name__ == '__main__':
    ...
    D4_rolls = tk.IntVar()
    D4_spinbox = tk.Spinbox(input_frame, from_=0, to=100, textvariable=D4_rolls, wrap=True)
    ...
    D6_rolls = tk.IntVar()
    D6_spinbox = tk.Spinbox(input_frame, from_=0, to=100, textvariable=D6_rolls, wrap=True)
    ...
    D8_rolls = tk.IntVar()
    D8_spinbox = tk.Spinbox(input_frame, from_=0, to=100, textvariable=D8_rolls, wrap=True)
    ...
    D10_rolls = tk.IntVar()
    D10_spinbox = tk.Spinbox(input_frame, from_=0, to=100, textvariable=D10_rolls, wrap=True)
    ...
    D12_rolls = tk.IntVar()
    D12_spinbox = tk.Spinbox(input_frame, from_=0, to=100, textvariable=D12_rolls, wrap=True)
    ...
    D20_rolls = tk.IntVar()
    D20_spinbox = tk.Spinbox(input_frame, from_=0, to=100, textvariable=D20_rolls, wrap=True)
    ...
    D100_spinbox = tk.Spinbox(input_frame, from_=0, to=100, textvariable=D100_rolls, wrap=True)
